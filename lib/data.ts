...
export const experience = [
  ...
  },
  {
    ...
    description:
      'My main work duties included cloning entire websites using Elementor Pro.',
    icon: React.createElement(TbWorldWww),
  ...
  },
  {
    ...
    location: '24HR, Malmö, Sweden',
    description:
      'My main duties as an intern included cloning entire websites using Elementor Pro.',
    icon: React.createElement(TbWorldWww),
