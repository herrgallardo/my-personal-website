...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-3">
        <p className="my-5">
          Born with an innate fascination for languages and cultures, I embarked
          on a journey that led me to acquire a degree in Spanish and
        ...
        <p className="my-5">
          ...
          programming. Over the years, I&apos;ve worn various hats, from diverse
          jobs in the cities of Granada and London to leading Spanish language
          sessions in Lund. My diverse work experiences, ranging from managerial
          roles in Spain to customer service in London, have ingrained in me a
          unique blend of soft skills and adaptability.
        </p>
        <p className="my-5">
          Whether managing a tavern in Granada or undertaking voluntary services
          in Eksjö, every experience has imparted lessons in collaboration,
